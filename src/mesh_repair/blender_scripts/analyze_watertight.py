...
File: /home/user/3d-printing-model-prompt/src/mesh_repair/blender_scripts/analyze_watertight.py
...
def analyze(bpy, input_path: str, viewer_output: str | None = None) -> dict:
    ...
    holes = [
        describe_hole(i, component)
        for i, component in enumerate(_shared.group_boundary_edges(boundary_edges))
    ]
