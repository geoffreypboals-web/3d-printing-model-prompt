...
File: /home/user/3d-printing-model-prompt/src/mesh_repair/blender_scripts/close_holes.py
...
def main():
    ...
    try:
        ...
        raise RuntimeError(
            "close_holes.py must be run inside Blender "
            "(blender --background --python close_holes.py -- ...)"
        ) from exc
